	...
	Subcommands: []*cli.Command{
		{
			...
			Description: "This command is deprecated, consider using `nextshieldaddress` instead. " +
				"This command helps generate the portal shielding address for a seed and a tokenID. ",
			Flags: []cli.Flag{
				defaultFlags[chainCodeFlag],
				&cli.StringFlag{
					Name:    tokenIDFlag,
					Aliases: aliases[tokenIDFlag],
		...
		},
		{
			...
			Description: "This command helps shield a portal token into the Incognito network after the fund has been " +
				"transferred to the depositing address (generated by `shieldaddress, shieldota`).",
			Flags: []cli.Flag{
				defaultFlags[privateKeyFlag],
				defaultFlags[externalTxIDFlag],
				&cli.StringFlag{
		...
		},
		{
			...
			Flags: []cli.Flag{
				...
				defaultFlags[depositPubKeyFlag],
				defaultFlags[signatureFlag],
				defaultFlags[receiverFlag],
			},
			Action: portalShieldWithDepositKey,
		},
		{
			Name:  "shieldstatus",
